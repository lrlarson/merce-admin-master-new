...
WHERE     (tbl_Events.eventEndDate > GETDATE())
    ...
    <cffunction name="deleteLicenseNew" access="remote" returntype="Any" returnformat="JSON">
    <cfargument name="id" type="numeric" >
    <cfquery name="queryName" datasource="merce_5">
    ...
    <cffunction name="insertNewHomePageVideo" access="remote" returntype="any">
        <cfargument name="webvideo" type="any">
        <cfif webvideo.publish EQ 'true'>
            <cfset webvideo.publish = 1>
        <cfelse>
            <cfset webvideo.publish = 0>
        </cfif>
        <cfquery name="video" datasource="merce_5">
            insert into tbl_WebVideos (fileName, Credit, Description, assetTarget, thumb, publish)
            values (
            '#webvideo.filename#',
            '#webvideo.Credit#',
    ...
    <cffunction name="updateHomePageVideo" access="remote" returntype="any">
        <cfargument name="webvideo" type="any">
        <cfif webvideo.publish EQ 'true'>
            <cfset webvideo.publish = 1>
            <cfelse>
        ...
        <cfquery name="update" datasource="merce_5">
            ...
            set
            fileName = '#webvideo.Filename#',
            Credit = '#webvideo.Credit#',
            Description = '#webvideo.Description#',
            thumb = '#webvideo.thumb#',
            publish = #webvideo.publish#
            where id = #webvideo.id#
        </cfquery>
        <cfreturn 1>
    </cffunction>


    <cffunction name="getSpecificWebVideo" access="remote" returntype="any">
        <cfargument name="id" type="numeric" required="true">
        <cfquery name="video" datasource="merce_5">
    ...
    <cffunction name="getWebVideos" access="remote" returntype="any">
    ...
    <cffunction name="insertNewRevival" access="remote" returntype="any">
        <cfargument name="revival" type="any">
        <cfquery name="newRevival" datasource="merce_5">
            ...
            '#revival.revivalYear#',
        '#revival.city#',
        '#revival.revivalNotes#'
            )
            select @@identity as newRevival
        </cfquery>
        <cfreturn newRevival>
    </cffunction>


    <cffunction name="updateRevival" access="remote" returntype="any">
        <cfargument name="revival" type="any">
        <cfquery name="revival" datasource="merce_5">
            update tbl_Revivals
            set revivalYear = '#revival.revivalYear#',
            city = '#revival.city#',
            revivalNotes = '#revival.revivalNotes#'
            where id = #revival.id#
        </cfquery>
        <cfreturn 1>
    </cffunction>

    <cffunction name="getRevivalsForWork" access="remote" returntype="any">
    ...
    <cffunction name="insertRelatedDance" access="remote" returntype="any">
    ...
    <cffunction name="insertNewLicense" access="remote" returntype="any">
        <cfargument name="lic" type="any" required="true">
            <cfif lic.active EQ 'true'>
                <cfset lic.active = 1>
            <cfelse>
                <cfset lic.active = 0>
            </cfif>
            <cfquery name="newLic" datasource="merce_5">
                ...
                (yearString, danceName,  company, stager, licType, referenceYear, location, licImage, description, active,licImageCredit )
                values (
                '#lic.yearString#', '#lic.danceName#', '#lic.company#', '#lic.stager#', #lic.licType#, #lic.referenceYear#, '#lic.location#', '#lic.licImage#', '#lic.description#', #lic.active#,'#lic.licImageCredit#'
                )
                select @@IDENTITY
            </cfquery>
        <cfreturn newLic>
    ...
    <cffunction name="saveLicEdit" access="remote" returntype="any">
        <cfargument name="lic" type="any" required="true">
            <cfif lic.active EQ 'true'>
                <cfset lic.active = 1>
                <cfelse>
            ...
            <cfquery name="licEdit" datasource="merce_5">
                ...
                set yearString = '#lic.yearString#',
                stager = '#lic.stager#',
                  company = '#lic.company#',
                  licType = #lic.licType#,
                  licImage = '#lic.licImage#',
                  referenceYear = #lic.referenceYear#,
                  location = '#lic.location#',
                  description = '#lic.description#',
                  active = #lic.active#,
                  danceName = '#lic.danceName#',
                   licImageCredit = '#lic.licImageCredit#'
                where id = #lic.id#
            </cfquery>
        <cfreturn 1>
    </cffunction>
    ...
    <cffunction name="getLicTypes" access="remote" returntype="any">
    ...
    <cffunction name="getLicTypes2" access="remote" returntype="any">
        <cfquery name="licTypes" datasource="merce_5">
            select id as data, licType as Label from tbl_LicType
        </cfquery>
        <cfreturn licTypes>
    ...
    <cffunction name="getRelatedDanceForLic"    access="remote" returntype="any">
        <cfargument name="licID" type="numeric" required="true">
            <cfquery name="dances" datasource="merce_5">
                select tbl_Works.workTitle from  tbl_Lic_Dance inner join tbl_Works on tbl_Lic_Dance.danceID = tbl_Works.id
    ...
    <cffunction name="getDanceNames" access="remote" returntype="any">
        <cfquery name="dances" datasource="merce_5">
    ...
    <cffunction name="getLicensesNew" access="remote" returntype="Any">
...
order by tbl_LicenseNew.referenceYear DESC
    ...
    <cffunction name="getNewLicenseDetails" access="remote" returntype="any">
        <cfargument name="licID" type="numeric" required="true">
            <cfquery name="lic" datasource="merce_5">
...
VALUES  ( '#license.Licensee#' , -- Licensee - nvarchar(50)
    ...
    <cffunction name="deleteLicense" access="remote" returntype="any">
    <cfargument name="id" type="numeric" required="yes">
    <cfquery name="deleteLicense" datasource="merce_5">
    DELETE FROM dbo.tbl_Licenses
	WHERE id = #id#
    select #id#
    </cfquery>
    <cfreturn deleteLicense>
    </cffunction>
